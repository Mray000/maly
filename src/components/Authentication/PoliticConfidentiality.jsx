...
export const PoliticConfidentiality = ({ navigation }) => {
  let string = `
...
Регистрацией в приложении Пользователь подтверждает достижение возраста 18 лет и наличие гражданства Российской Федерации. В ином случае пользователь обязуется удалить приложение.
    ...
    <View>
      ...
      <ScrollView style={{ padding: 10 }}>
        <Text style={{ fontSize: 18 }}>
          Пользовательское Соглашение сервиса MALI
        </Text>
        <Text>{string}</Text>
      </ScrollView>
    </View>
